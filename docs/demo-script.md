...
| 2:30–2:50 | Verified result | Verification suite green; before/after table; MCP write approval; file downloads | "Fixes applied to a copy, verified with assertions — row counts reconcile, totals recompute, pipeline is idempotent." |
| 2:50–3:00 | Close | change_report.md + cleaned CSV side by side; repo URL | "Cleanroom: drop in messy data, get back data you trust. Repo in the description." |
